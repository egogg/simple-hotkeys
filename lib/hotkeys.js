(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simple-hotkeys', [[object Object]], function ($, SimpleModule) {
    ...
    // like Node.
    module.exports = factory([object Object]);
  } else {
    root.simple = root.simple || {};
    root.simple['hotkeys'] = factory([object Object]);
  }
...
Hotkeys = (function() {
  class Hotkeys extends SimpleModule {
    ...
    _init() {
      ...
      return $(this._delegate).on(`keydown.simple-hotkeys-${this.id}`, this.opts.el, (e) => {
        var ref;
        return (ref = this._getHander(e)) != null ? ref.call(this, e) : void 0;
      });
    }
